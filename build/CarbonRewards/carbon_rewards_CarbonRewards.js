...
exports.CarbonRewards = exports.CarbonRewards_getterMapping = exports.CarbonRewards_errors_backward = exports.CarbonRewards_errors = void 0;
...
exports.storeContractMetrics = storeContractMetrics;
exports.loadContractMetrics = loadContractMetrics;
exports.loadTupleContractMetrics = loadTupleContractMetrics;
exports.loadGetterTupleContractMetrics = loadGetterTupleContractMetrics;
exports.storeTupleContractMetrics = storeTupleContractMetrics;
exports.dictValueParserContractMetrics = dictValueParserContractMetrics;
exports.storeCarbonRewards$Data = storeCarbonRewards$Data;
exports.loadCarbonRewards$Data = loadCarbonRewards$Data;
exports.loadTupleCarbonRewards$Data = loadTupleCarbonRewards$Data;
exports.loadGetterTupleCarbonRewards$Data = loadGetterTupleCarbonRewards$Data;
exports.storeTupleCarbonRewards$Data = storeTupleCarbonRewards$Data;
exports.dictValueParserCarbonRewards$Data = dictValueParserCarbonRewards$Data;
...
function storeContractMetrics(src) {
    return (builder) => {
        const b_0 = builder;
        b_0.storeUint(3862829328, 32);
        b_0.storeInt(src.total_co2e_reduced_kg, 257);
        b_0.storeInt(src.total_carbon_credits_minted, 257);
        b_0.storeInt(src.total_sc_points_minted, 257);
    };
}
function loadContractMetrics(slice) {
    const sc_0 = slice;
    if (sc_0.loadUint(32) !== 3862829328) {
        throw Error('Invalid prefix');
    }
    const _total_co2e_reduced_kg = sc_0.loadIntBig(257);
    const _total_carbon_credits_minted = sc_0.loadIntBig(257);
    const _total_sc_points_minted = sc_0.loadIntBig(257);
    return { $$type: 'ContractMetrics', total_co2e_reduced_kg: _total_co2e_reduced_kg, total_carbon_credits_minted: _total_carbon_credits_minted, total_sc_points_minted: _total_sc_points_minted };
}
function loadTupleContractMetrics(source) {
    const _total_co2e_reduced_kg = source.readBigNumber();
    const _total_carbon_credits_minted = source.readBigNumber();
    const _total_sc_points_minted = source.readBigNumber();
    return { $$type: 'ContractMetrics', total_co2e_reduced_kg: _total_co2e_reduced_kg, total_carbon_credits_minted: _total_carbon_credits_minted, total_sc_points_minted: _total_sc_points_minted };
}
function loadGetterTupleContractMetrics(source) {
    const _total_co2e_reduced_kg = source.readBigNumber();
    const _total_carbon_credits_minted = source.readBigNumber();
    const _total_sc_points_minted = source.readBigNumber();
    return { $$type: 'ContractMetrics', total_co2e_reduced_kg: _total_co2e_reduced_kg, total_carbon_credits_minted: _total_carbon_credits_minted, total_sc_points_minted: _total_sc_points_minted };
}
function storeTupleContractMetrics(source) {
    const builder = new core_1.TupleBuilder();
    builder.writeNumber(source.total_co2e_reduced_kg);
    builder.writeNumber(source.total_carbon_credits_minted);
    builder.writeNumber(source.total_sc_points_minted);
    return builder.build();
}
function dictValueParserContractMetrics() {
    return {
        serialize: (src, builder) => {
            builder.storeRef((0, core_1.beginCell)().store(storeContractMetrics(src)).endCell());
        },
        parse: (src) => {
            return loadContractMetrics(src.loadRef().beginParse());
        }
    };
}
function storeCarbonRewards$Data(src) {
    return (builder) => {
        const b_0 = builder;
        b_0.storeAddress(src.owner);
        b_0.storeUint(src.total_co2e_reduced_kg, 64);
        b_0.storeUint(src.total_carbon_credits_minted, 64);
        b_0.storeUint(src.total_sc_points_minted, 64);
    };
}
function loadCarbonRewards$Data(slice) {
    const sc_0 = slice;
    const _owner = sc_0.loadAddress();
    const _total_co2e_reduced_kg = sc_0.loadUintBig(64);
    const _total_carbon_credits_minted = sc_0.loadUintBig(64);
    const _total_sc_points_minted = sc_0.loadUintBig(64);
    return { $$type: 'CarbonRewards$Data', owner: _owner, total_co2e_reduced_kg: _total_co2e_reduced_kg, total_carbon_credits_minted: _total_carbon_credits_minted, total_sc_points_minted: _total_sc_points_minted };
}
function loadTupleCarbonRewards$Data(source) {
...
function loadGetterTupleCarbonRewards$Data(source) {
    const _owner = source.readAddress();
    const _total_co2e_reduced_kg = source.readBigNumber();
    const _total_carbon_credits_minted = source.readBigNumber();
    const _total_sc_points_minted = source.readBigNumber();
...
function storeTupleCarbonRewards$Data(source) {
    const builder = new core_1.TupleBuilder();
...
function dictValueParserCarbonRewards$Data() {
    return {
        serialize: (src, builder) => {
            builder.storeRef((0, core_1.beginCell)().store(storeCarbonRewards$Data(src)).endCell());
        },
        parse: (src) => {
            return loadCarbonRewards$Data(src.loadRef().beginParse());
        }
    };
}
function initCarbonRewards_init_args(src) {
    return (builder) => {
        const b_0 = builder;
    };
}
async function CarbonRewards_init() {
    const __code = core_1.Cell.fromHex('');
    const builder = (0, core_1.beginCell)();
    builder.storeUint(0, 1);
    initCarbonRewards_init_args({ $$type: 'CarbonRewards_init_args' })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}
exports.CarbonRewards_errors = {
...
exports.CarbonRewards_errors_backward = {
    "Stack underflow": 2,
    "Stack overflow": 3,
    "Integer overflow": 4,
...
const CarbonRewards_types = [
    ...
    { "name": "ContractMetrics", "header": 3862829328, "fields": [{ "name": "total_co2e_reduced_kg", "type": { "kind": "simple", "type": "int", "optional": false, "format": 257 } }, { "name": "total_carbon_credits_minted", "type": { "kind": "simple", "type": "int", "optional": false, "format": 257 } }, { "name": "total_sc_points_minted", "type": { "kind": "simple", "type": "int", "optional": false, "format": 257 } }] },
    { "name": "CarbonRewards$Data", "header": null, "fields": [{ "name": "owner", "type": { "kind": "simple", "type": "address", "optional": false } }, { "name": "total_co2e_reduced_kg", "type": { "kind": "simple", "type": "uint", "optional": false, "format": 64 } }, { "name": "total_carbon_credits_minted", "type": { "kind": "simple", "type": "uint", "optional": false, "format": 64 } }, { "name": "total_sc_points_minted", "type": { "kind": "simple", "type": "uint", "optional": false, "format": 64 } }] },
];
const CarbonRewards_opcodes = {
    "Deploy": 2490013878,
    "DeployOk": 2952335191,
    "FactoryDeploy": 1829761339,
    "ContractMetrics": 3862829328,
};
const CarbonRewards_getters = [
    { "name": "getMetrics", "methodId": 90736, "arguments": [], "returnType": { "kind": "simple", "type": "ContractMetrics", "optional": false } },
    { "name": "getOracle", "methodId": 106528, "arguments": [], "returnType": { "kind": "simple", "type": "address", "optional": false } },
];
exports.CarbonRewards_getterMapping = {
    'getMetrics': 'getGetMetrics',
    'getOracle': 'getGetOracle',
};
const CarbonRewards_receivers = [
    { "receiver": "internal", "message": { "kind": "text", "text": "RecordCarbon" } },
    { "receiver": "internal", "message": { "kind": "typed", "type": "Deploy" } },
];
class CarbonRewards {
    static storageReserve = 0n;
    static errors = exports.CarbonRewards_errors_backward;
    static opcodes = CarbonRewards_opcodes;
    static async init() {
        return await CarbonRewards_init();
    }
    static async fromInit() {
        const __gen_init = await CarbonRewards_init();
        const address = (0, core_1.contractAddress)(0, __gen_init);
        return new CarbonRewards(address, __gen_init);
    }
    static fromAddress(address) {
        return new CarbonRewards(address);
    }
    address;
    init;
    abi = {
        types: CarbonRewards_types,
        getters: CarbonRewards_getters,
        receivers: CarbonRewards_receivers,
        errors: exports.CarbonRewards_errors,
    };
    ...
    async getGetMetrics(provider) {
        const builder = new core_1.TupleBuilder();
        const source = (await provider.get('getMetrics', builder.build())).stack;
        const result = loadGetterTupleContractMetrics(source);
        return result;
    }
    async getGetOracle(provider) {
        const builder = new core_1.TupleBuilder();
...
exports.CarbonRewards = CarbonRewards;
